...
(function (global, factory) {
  ...
  function () {
    ...
    */
    ...
    IroColor.kelvinToRgb = function kelvinToRgb(kelvin,realValues = false) {
      var temp = kelvin / 100;
      var r, g, b;
      ...
      // console.log(`kelvinToRgb r:${r} g:${g} b:${b} temp:${kelvin}`);
      return {
    ...
    */
    ...
    IroColor.rgbToKelvin = function rgbToKelvin(rgb) {
      ...
      var temp;
      //console.log(`rgbToKelvin start r:${r} g:${g} b:${b} min:${KELVIN_MIN}`)
      while (maxTemp - minTemp > eps) {
        ...
        } else { // below 2000k where blue is 0;
          if (_rgb.g >= g) {
            maxTemp = temp;
          } else {
            minTemp = temp;
      ...
      //console.log(`rgbToKelvin r:${r} b:${b} temp:${temp}`)
      return temp;
    };
